...
// ### Constructor
CTS.Adapters.Html.HtmlNode = function(node, tree, opts) {
  opts = opts || {};
...
// ### Instance Methods
CTS.Fn.extend(CTS.Adapters.Html.HtmlNode.prototype, CTS.Node.Base, CTS.Events, CTS.Adapters.Html.HtmlNodeBase, {
   ...
   _subclass_realizeChildren: function() {
     ...
     var promises = CTS.Fn.map(this.value.children(), function(child) {
       var promise = CTS.Adapters.Html.Factory.HtmlNode(child, self.tree, self.opts);
       return promise;
     });
   ...
   _onChildInserted: function(child) {
     var self = this;
     CTS.Adapters.Html.Factory.HtmlNode(child, this.tree, this.opts).then(
       function(ctsChild) {
