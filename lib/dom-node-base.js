...
var HtmlNodeBase = {
  ...
  _rewriteQuiltVariant: function(attr, s) {
    ...
    } else if (match = connectR.exec(attr)) {
  ...
  _subclass_getInlineRelationSpecString: function() {
    if (this.value !== null) {
      ...
      } else if (inline = this.value.attr('connect-class')) {
        return this._rewriteQuiltVariant('connect-class', inline);
      } else if (inline = this.value.attr('connect-href')) {
        return this._rewriteQuiltVariant('connect-href', inline);
      } else if (inline = this.value.attr('connect-src')) {
        return this._rewriteQuiltVariant('connect-src', inline);
      ...
      } else if (inline = this.value.attr('updates')) {
        return this._rewriteQuiltVariant('updates', inline);        
      } else if (inline = this.value.attr('widget')) {
        return this._rewriteQuiltVariant('widget', inline);        
      }
    }
    return null;
  },
